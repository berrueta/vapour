...
(function($) {
	...
	$.csv2table={
		...
		loadImg  : (new Image()).src='resources/images/icon-loadinfo.gif',  //Dafault loading IMG 
		sortNImg : (new Image()).src='resources/images/icon-n.gif',         //Dafault sort IMG N
		sortDImg : (new Image()).src='resources/images/icon-d-green.gif',   //Dafault sort IMG D 
		sortAImg : (new Image()).src='resources/images/icon-a-green.gif',   //Dafault sort IMG A
		setting  : [],
		data     : [],
		_rowsAry : [],
		_doc     : document,
