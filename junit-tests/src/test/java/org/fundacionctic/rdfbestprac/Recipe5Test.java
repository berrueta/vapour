...
public class Recipe5Test extends AbstractTestCase {
	
    private static final String BASE_URI = COMMON_BASE_URI + "example5/";
    private static final String RDF_BASE_URI = COMMON_BASE_URI + "example5-content/2005-10-31.rdf";
    private static final String HTML_BASE_URI = COMMON_BASE_URI + "example5-content/2005-10-31-docs/";
	...
	public void testVocabularyHTML() throws Exception {
    	...
    	assertEquals(HTML_BASE_URI + "index.html", getLocation(resp));
    ...
    public void testClassDefinitionHTML() throws Exception {
    	...
    	assertResponseCode303(resp);
    	assertEquals(HTML_BASE_URI + "ClassA.html", getLocation(resp));
    	WebResponse resp2 = followRedirect(resp);
    	assertResponseCode200(resp2);
    	assertContentTypeHtml(resp2);    	
    }
    ...
    public void testPropertyDefinitionHTML() throws Exception {
    	...
    	assertResponseCode303(resp);
    	assertEquals(HTML_BASE_URI + "propA.html", getLocation(resp));
    	WebResponse resp2 = followRedirect(resp);
    	assertResponseCode200(resp2);
    	assertContentTypeHtml(resp2);
    }
