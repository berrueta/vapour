...
public class Recipe3Test extends AbstractTestCase {

    private static final String BASE_URI = COMMON_BASE_URI + "example3";
    private static final String RDF_BASE_URI = COMMON_BASE_URI + "example3-content/2005-10-31.rdf";
    private static final String HTML_BASE_URI = COMMON_BASE_URI + "example3-content/2005-10-31.html";
